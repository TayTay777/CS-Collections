 ...
 * Tests for Change Scenario 38: [A, B, C] -> iterator remove() after next() B -> [A, C]
 * 
 * @author CS221
 */
public class Test_ABC_IterRemoveB_AC {
	...
	public void initialize(String listType)
	{
		...
		list.add(TestCase.C);
		// make change to list 
		Iterator<Integer> itr = TestCase.initItr(list, TestCase.ItrState.nextNext);
		itr.remove();
	}
