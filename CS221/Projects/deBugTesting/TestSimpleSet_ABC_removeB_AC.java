 ...
 * @author CS221
 */
public class TestSimpleSet_ABC_removeB_AC
{
	// SimpleSet running tests on 
	private SimpleSet<Integer> set; 
	// variables for tests 
	private final int SIZE = 2; 
//	private static final Object[][] VALID_ELEMENTS = { {SetTestCase.A}, {SetTestCase.C} }; //MV: can't get this to work, so ditching it
...
//	}
	...
	/**
	 * Test: contains(B) 
	 * - whether set contains an element B not in set
	 * Expected Result: False
	 */
	@Test
...
//	}
	...
	/**
	 * Test: remove(B) 
	 * - tries to remove element B not in set from set
