 ...
 * Tests for Scenario: [A,B,C] -> add(C) -> [A,B,C]
 *
 * @author CS221
 */
public class TestSimpleSet_ABC_addC_ABC
{
	// SimpleSet running tests on 
	private SimpleSet<Integer> set; 
	// variables for tests 
	private final int SIZE = 3; 
//	private static final Object[][] VALID_ELEMENTS = { {SetTestCase.A}, {SetTestCase.B}, {SetTestCase.C} }; //MV: can't get this to work, so ditching it
