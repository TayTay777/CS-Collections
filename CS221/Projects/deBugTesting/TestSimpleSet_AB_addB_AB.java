 ...
 * Tests for Scenario: [A,B] -> add(B) -> [A,B]
 *
 * @author CS221
 */
public class TestSimpleSet_AB_addB_AB
{
...
//	private static final Object[][] VALID_ELEMENTS = { {SetTestCase.A}, {SetTestCase.B} }; //MV: can't get this working, so ditching it
