 ...
 * Tests for Change Scenario 38: [A, B, C] -> iterator remove() after next() C -> [A, B]
 * 
 * @author CS221
 */
public class Test_ABC_IterRemoveC_AB {
	...
	public void initialize(String listType)
	{
		...
		list.add(TestCase.C);
		// make change to list 
		Iterator<Integer> itr = TestCase.initItr(list, TestCase.ItrState.nextNextNext);
		itr.remove();
	}
