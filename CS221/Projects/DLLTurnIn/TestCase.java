 ...
 * IndexedUnorderedList interface. ListIterator tests
 * also require implementation of IUListWithListIterator.
 * 
 * @author CS221
 */
public class TestCase
{
	...
	public enum ListItrState { init, init0, init1, init2, init3, add, next,
		nextAdd, nextSet, nextRemove, nextNext, nextPrev, 
		nextNextAdd, nextNextSet, nextNextRemove, nextNextNext, nextNextPrev, 
		nextPrevAdd, nextPrevSet, nextPrevRemove,
		nextNextNextAdd, nextNextNextSet, nextNextNextRemove, nextNextNextPrev,
		nextNextPrevAdd, nextNextPrevSet, nextNextPrevRemove, 
		nextNextNextPrevAdd, nextNextNextPrevSet, nextNextNextPrevRemove, 
		nextAddPrev, nextNextAddPrev, nextNextNextAddPrev,
		nextSetPrev, nextnextSetPrev, nextNextNextSetPrev} 
...
//			newList = new IUSingleLinkedList<Integer>(); 
		...
		else if(listType.equals("wrappedDLL"))
		{
//			newList = new WrappedDLL<Integer>();
		}
	 ...
	 */
	public static void listIterator(IUListWithListIterator<Integer> list)
	{
	 ...
	 * @param itr - ListIterator over list implementation of IUListWithListIterator interface
	 * @param expectedResult - boolean value 
	 */
	 ...
	 */
	public static ListIterator<Integer> initListItr(IUListWithListIterator<Integer> list, ListItrState listItrState)
	{
		...
		case  init0:
			listItr = list.listIterator(0);
			break;
		case init1:
			listItr = list.listIterator(1);
			break;
		case init2:
			listItr = list.listIterator(2);
			break;
		case init3:
		...
		case nextSetPrev:
			...
			listItr.previous();
			break;
		case nextnextSetPrev:
			listItr.next();
			listItr.next();
			listItr.set(E);
			listItr.previous();
			break;
		case nextNextNextSetPrev: 
			listItr.next();
			listItr.next();
			listItr.next();
			listItr.set(E);
