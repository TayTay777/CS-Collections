...
public class ListItrTest_ABCD_remove1_ACD {

	/**
	 * Testing for IUListWithListIterator interface implementation: 
	 * ListIterator Tests for Change Scenario [A, B, C, D] -> remove(1) -> [A, C, D]
	 * 
