...
class CPUScheduling
{
	...
	for (int currentTime = 0; currentTime < simulationTime; currentTime++)
		...
		// Checks to see if there is any incoming new process.
		...
		//'if' statement for updating processes in the queue
		if (!pqueue.isEmpty())
		    {
			...
			//next line only effects the queue, not the process 'next'
			//which has been pulled out of the queue using dePQueue method
