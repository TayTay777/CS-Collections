...
/**
 * Prompt for a file to read. Read the file one line at a time, break each line into individual tokens (words), 
 * and output all tokens to the console, one token per output line.
 * 
 * @author mvail
 */
